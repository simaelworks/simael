...
<div class="min-h-screen flex fle-col items-center justify-center p-6">
    ...
    <div class="grid lg:grid-cols-2 items-center gap-8 max-w-6xl max-lg:max-w-lg w-full">
        ...
        <form class="lg:max-w-md w-full" action="{{ route('register') }}" method="post">
            ...
            <h1 class="text-slate-900 text-3xl font-semibold mb-8 dark:text-blue-300">Buat akun Murid</h1>

            <div class="space-y-6">

                {{-- Nama --}}
                <div>
                    <label class="text-slate-900 dark:text-white text-sm mb-2 block">Nama</label>
                ...
                {{-- NISN --}}
                <div>
                    <label class="text-slate-900 dark:text-white text-sm mb-2 block">NISN</label>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button"
                            ...
                            {{-- Eye open --}}
                            <svg id="eye-open-1" class="w-5 h-5" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
                            ...
                            {{-- Eye closed --}}
                            <svg id="eye-closed-1" class="w-5 h-5 hidden" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button"
                            onclick="togglePassword('confirm-password', 'eye-open-2', 'eye-closed-2')"
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-300
                                  hover:text-gray-700 focus:outline-none">

                            {{-- Eye open --}}
                            <svg id="eye-open-2" class="w-5 h-5" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            {{-- Eye closed --}}
                            <svg id="eye-closed-2" class="w-5 h-5 hidden" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mt-6">
                <button type="submit"
                        class="py-3 px-6 text-sm text-white tracking-wide bg-blue-600
                               hover:bg-blue-700 focus:outline-none cursor-pointer">
                    Buat
                </button>
            </div>

            <p class="text-sm text-slate-600 dark:text-gray-300 mt-6">
                Sudah punya akun?
                <a href="{{ route('loginPage') }}" class="text-blue-600 font-semibold hover:underline ml-1">
                    Login disini
                </a>
            </p>
        ...
        <div class="h-full">
            <img src="https://readymadeui.com/login-image.webp"
                 class="w-full h-full object-contain aspect-628/516"
                 alt="login img" />
        </div>
