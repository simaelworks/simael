            ...
            <div>
                <span class="inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    @php
                        ...
                        $windowSize = 5;
                        $half = intval($windowSize / 2);
                        
                        // Calculate start and end to keep current page in the middle
                        $groupStart = max(1, $current - $half);
                        $groupEnd = min($last, $groupStart + $windowSize - 1);
                        
                        // Adjust if we're near the end
                        if ($groupEnd - $groupStart + 1 < $windowSize && $last >= $windowSize) {
                            $groupStart = max(1, $groupEnd - $windowSize + 1);
                        }
                    @endphp
